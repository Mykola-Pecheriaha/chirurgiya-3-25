...
import styles from './LiposuctionGalleryFAQ.module.css';
...
interface LiposuctionGalleryFAQProps {
  images: GalleryImage[];
}

export function LiposuctionGalleryFAQ({ images }: LiposuctionGalleryFAQProps) {
...
export default LiposuctionGalleryFAQ;
