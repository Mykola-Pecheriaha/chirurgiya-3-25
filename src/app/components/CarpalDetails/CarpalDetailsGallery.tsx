...
const galleryImages = [
  {
    src: '/images/carpalDetails/carp24.jpg',
    alt: "Анатомія зап'ястного каналу",
    width: 800,
    height: 600,
    title: "Анатомія зап'ястного каналу",
  },
  {
    src: '/images/carpalDetails/carpal8.jpg',
    alt: "Серединний нерв у зап'ястному каналі",
    width: 800,
    height: 600,
    title: "Серединний нерв у зап'ястному каналі",
  },
  {
    src: '/images/carpalDetails/carpale1.jpg',
    alt: "Симптоми синдрому зап'ястного каналу",
    width: 800,
    height: 600,
    title: "Симптоми синдрому зап'ястного каналу",
  },
  {
    src: '/images/carpalDetails/carpale15.jpg',
    alt: "Лікування синдрому зап'ястного каналу",
    width: 800,
    height: 600,
    title: "Лікування синдрому зап'ястного каналу",
  },
];

export function CarpalDetailsGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=carpal tunnel syndrome'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=carpal tunnel syndrome thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
