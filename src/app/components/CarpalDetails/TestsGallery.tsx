...
const galleryImages = [
  {
    src: '/images/carpalDetails/carpale30.jpg',
    alt: 'Симптом Тінеля',
    width: 800,
    height: 600,
  ...
  {
    src: '/images/carpalDetails/carpale31.jpg',
    alt: 'Тест Фалена',
    width: 800,
    height: 600,
    title: 'Тест Фалена',
  ...
  {
    src: '/images/carpalDetails/carpale32.jpg',
    alt: 'Електроміографія (ЕМГ)',
    width: 800,
    height: 600,
    title: 'Електроміографія (ЕМГ)',
  },
  {
    src: '/images/carpalDetails/carpale33.jpg',
    alt: 'Тест на швидкість нервової провідності',
    width: 800,
    height: 600,
    title: 'Тест на швидкість нервової провідності',
  },
];

export function TestsGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=carpal tunnel syndrome tests'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=carpal tunnel syndrome tests thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
