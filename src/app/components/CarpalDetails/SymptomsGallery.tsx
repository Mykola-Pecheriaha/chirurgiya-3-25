...
const galleryImages = [
  {
    src: '/images/carpalDetails/carpale16.jpg',
    alt: 'Оніміння та поколювання в пальцях',
    width: 800,
    height: 600,
    title: 'Оніміння та поколювання в пальцях',
  },
  {
    src: '/images/carpalDetails/carpale27.jpg',
    alt: 'Слабкість та незграбність руки',
    width: 800,
    height: 600,
    title: 'Слабкість та незграбність руки',
  },
  {
    src: '/images/carpalDetails/carpal5.jpg',
    alt: "Атрофія м'яза під великим пальцем",
    width: 800,
    height: 600,
    title: "Атрофія м'яза під великим пальцем",
  },
  {
    src: '/images/carpalDetails/carpale29.jpg',
    alt: "Нічні симптоми синдрому зап'ястного каналу",
    width: 800,
    height: 600,
    title: "Нічні симптоми синдрому зап'ястного каналу",
  },
];

export function SymptomsGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=carpal tunnel syndrome symptoms'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=carpal tunnel syndrome symptoms thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default SymptomsGallery;
