...
const galleryImages = [
  {
    src: '/images/carpalDetails/carpal7.jpg',
    alt: "Повторювані рухи рук як причина синдрому зап'ястного каналу",
    width: 800,
    height: 600,
    title: 'Повторювані рухи рук',
  },
  {
    src: '/images/carpalDetails/carp56.jpg',
    alt: "Незручне положення руки та зап'ястя",
    width: 800,
    height: 600,
    title: "Незручне положення руки та зап'ястя",
  },
  {
    src: '/images/carpalDetails/carpale25.jpg',
    alt: "Анатомічні особливості зап'ястного каналу",
    width: 800,
    height: 600,
    title: "Анатомічні особливості зап'ястного каналу",
  },
  {
    src: '/images/carpalDetails/carpale26.jpg',
    alt: 'Професійні фактори ризику',
    width: 800,
    height: 600,
    title: 'Професійні фактори ризику',
  },
];
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=carpal tunnel syndrome causes'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=carpal tunnel syndrome causes thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
