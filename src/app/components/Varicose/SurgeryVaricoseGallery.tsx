...
const galleryImages = [
  {
    src: '/images/varicose/varicos22.jpg',
    alt: 'Склеротерапія',
    width: 800,
    height: 600,
    title: 'Склеротерапія',
  },
  {
    ...
    alt: 'Лазерне лікування варикозу',
    width: 800,
    height: 600,
    title: 'Лазерне лікування варикозу',
  },
  {
    src: '/images/varicose/varicos24.jpg',
    alt: 'Мінімально інвазивна хірургія',
    width: 800,
    height: 600,
    title: 'Мінімально інвазивна хірургія',
  },
  {
    src: '/images/varicose/varicos25.jpg',
    alt: 'Компресійна терапія',
    width: 800,
    height: 600,
    title: 'Компресійна терапія',
  },
];

export function SurgeryVaricoseGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              `/placeholder.svg?height=600&width=800&query=varicose surgery ${currentIndex + 1 || '/placeholder.svg'}` ||
              '/placeholder.svg'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        `/placeholder.svg?height=75&width=100&query=varicose surgery thumbnail ${index + 1 || '/placeholder.svg'}` ||
                        '/placeholder.svg'
                      }
                      alt={image.alt}
                      width={100}
