...
const galleryImages = [
  {
    src: '/images/varicose/varicos18.jpg',
    alt: 'Стадії варикозної хвороби',
    width: 800,
    height: 600,
    title: 'Стадії варикозної хвороби',
  },
  {
    src: '/images/varicose/varicos19.jpg',
    alt: 'Видимі варикозно розширені вени',
    width: 800,
    height: 600,
    title: 'Видимі варикозно розширені вени',
  },
  {
    src: '/images/varicose/varicos20.jpg',
    alt: 'Зміни шкіри при варикозі',
    width: 800,
    height: 600,
    title: 'Зміни шкіри при варикозі',
  },
  {
    src: '/images/varicose/varicos21.jpg',
    alt: 'Трофічні виразки при варикозі',
    width: 800,
    height: 600,
    title: 'Трофічні виразки при варикозі',
  },
  {
    src: '/images/varicose/varicos17.jpg',
    alt: 'Трофічні виразки при варикозі',
    width: 800,
    height: 600,
    title: 'Трофічні виразки при варикозі',
...
export function SymptomsVaricoseGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              `/placeholder.svg?height=600&width=800&query=varicose symptoms ${currentIndex + 1 || '/placeholder.svg'}` ||
              '/placeholder.svg'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        `/placeholder.svg?height=75&width=100&query=varicose symptoms thumbnail ${index + 1 || '/placeholder.svg'}` ||
                        '/placeholder.svg'
                      }
                      alt={image.alt}
                      width={100}
