    ...
    <div className={styles.container} style={{ backgroundColor }}>
      ...
      <div className={styles.sectionContainer}>
        <div className={styles.textSection}>
          <h3 className={styles.sectionTitle}>🧬 Причини розвитку варикозу:</h3>
      ...
      <div className={styles.fullWidthSection}>
        <p className={styles.fullWidthText}>
          💡 Чому важливо лікувати варикоз: Лікування має не лише медичні, але й
          естетичні показання. Особливо це турбує жінок, які хочуть повернути
          ногам красу 👠 🔔 Не відкладайте звернення до лікаря — сучасна
          флебологія дозволяє лікувати варикоз швидко, ефективно та безболісно.
        </p>
      </div>
      ...
      <div className={styles.sectionContainer}>
        <div className={styles.textSection}>
          <h3 className={styles.sectionTitle}>💡 Сучасні методи лікування:</h3>
          <div className={styles.expandableText}>
            {expandedSections.treatment ? (
              <div className={styles.textContent}>
                ...
                <ul className={styles.bulletList}>
                  <li className={styles.bulletItem}>
                    Існує ризик рецидиву, якщо не відновити нормальний венозний
                    кровотік.
                  </li>
                  <li className={styles.bulletItem}>
                ...
                <p>
                  Лазерний промінь нагріває стінки вени, змушуючи її закритися.
                </p>
      ...
      <div className={styles.fullWidthSection}>
        ...
        <p className={styles.fullWidthText}>
          ...
          пропонуємо декілька варіантів терапії з детальним поясненням переваг і
