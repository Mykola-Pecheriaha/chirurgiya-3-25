...
import styles from './BreastLiftGallery.module.css';

// Явно експортуємо інтерфейс, щоб його можна було імпортувати в інших файлах
export interface BreastLiftGalleryProps {
  images: string[];
  galleryId: string;
}
...
const BreastLiftGallery: React.FC<BreastLiftGalleryProps> = ({
  images,
  galleryId,
}) => {
