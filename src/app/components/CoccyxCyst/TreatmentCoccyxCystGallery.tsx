...
const galleryImages = [
  {
    src: '/images/coccyx/hemorroy18.jpg',
    alt: 'Консервативне лікування кісти куприка',
    width: 800,
    height: 600,
    title: 'Консервативне лікування',
  },
  {
    src: '/images/coccyx/coccyx15.jpg',
    alt: 'Хірургічне лікування кісти куприка',
    width: 800,
    height: 600,
    title: 'Хірургічне лікування',
  },
  {
    src: '/images/coccyx/coccyx12.jpg',
    alt: 'Лазерна вапоризація кісти куприка',
    width: 800,
    height: 600,
    title: 'Лазерна вапоризація',
  },
  {
    src: '/images/coccyx/coccyx13.jpg',
...
export function TreatmentCoccyxCystGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=coccyx treatment' ||
              '/placeholder.svg'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=coccyx treatment thumbnail' ||
                        '/placeholder.svg'
                      }
                      alt={image.alt}
                      width={100}
...
export default TreatmentCoccyxCystGallery;
