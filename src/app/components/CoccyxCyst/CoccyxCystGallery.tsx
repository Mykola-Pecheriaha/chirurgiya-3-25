...
const galleryImages = [
  {
    ...
    alt: 'Недотримання гігієни',
    width: 800,
    height: 600,
    title: 'Недотримання гігієни',
  },
  {
    src: '/images/coccyx/coccyx17.jpg',
    alt: 'Рясне оволосіння міжсідничної ділянки',
    width: 800,
    height: 600,
    title: 'Рясне оволосіння міжсідничної ділянки',
  },
  {
    src: '/images/coccyx/coccyx20.jpg',
    alt: 'Біль під час сидіння',
    width: 800,
    height: 600,
    title: 'Біль під час сидіння',
  },
  {
    src: '/images/coccyx/coccyx19.jpg',
    alt: 'Запалення та набряк у ділянці куприка',
    width: 800,
    height: 600,
    title: 'Запалення та набряк у ділянці куприка',
  },
];

export function CoccyxCystGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=coccyx' ||
              '/placeholder.svg'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=coccyx thumbnail' ||
                        '/placeholder.svg'
                      }
                      alt={image.alt}
                      width={100}
