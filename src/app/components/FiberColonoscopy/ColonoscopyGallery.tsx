...
const galleryImages = [
  {
    src: '/images/fiberGastroscopy/FiberColonoscopy1.jpg',
    alt: 'Процедура колоноскопії',
    width: 800,
    height: 600,
    title: 'Процедура колоноскопії',
  },
  {
    src: '/images/fiberGastroscopy/FiberColonoscopy2.jpg',
    alt: 'Обладнання для колоноскопії',
    width: 800,
    height: 600,
    title: 'Сучасне обладнання для колоноскопії',
  },
];

export function ColonoscopyGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=colonoscopy procedure'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=colonoscopy thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default ColonoscopyGallery;
