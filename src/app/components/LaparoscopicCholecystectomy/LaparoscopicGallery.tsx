...
import styles from './LaparoscopicGallery.module.css';

// Визначаємо зображення безпосередньо в компоненті галереї
const galleryImages = [
  {
    src: '/images/cholecystectomy/laparoscopyDiagnostic10.jpg',
    alt: 'Лапароскопічне обладнання для холецистектомії',
    width: 800,
    height: 600,
    title: 'Сучасне лапароскопічне обладнання',
  },
  {
    src: '/images/cholecystectomy/cholecystectomy5.jpg',
    alt: 'Лапароскопічна холецистектомія процедура',
    width: 800,
    height: 600,
    title: 'Анатомія ж/міхура ',
  },

  {
    src: '/images/cholecystectomy/cholecystectomy4.jpg',
    alt: 'Схема лапароскопічної холецистектомії',
    width: 800,
    height: 600,
    title: 'Схема лапароскопічної холецистектомії',
  },

  {
    src: '/images/cholecystectomy/cholecystectomy7.jpg',
    alt: 'Хід операції',
    width: 800,
    height: 600,
    title: 'Хід операції',
  ...
  {
    src: '/images/cholecystectomy/laparoscopyDiagnostic6.jpg',
    alt: 'Хід операції',
    width: 800,
    height: 600,
    title: 'Процес лапароскопічної холецистектомії',
  },
  {
    src: '/images/cholecystectomy/cholecystectomy8.jpg',
    alt: 'Результати лапароскопічної холецистектомії',
    width: 800,
    height: 600,
    title: 'Результати лапароскопічної холецистектомії',
  },
];

export function LaparoscopicGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=laparoscopic cholecystectomy'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=laparoscopic cholecystectomy thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default LaparoscopicGallery;
