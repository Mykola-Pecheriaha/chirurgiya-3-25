...
export function HemorrSymptomGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=hemorrhoid symptoms'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=hemorrhoid symptoms thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default HemorrSymptomGallery;
