...
const galleryImages = [
  {
    src: '/images/sterility/operromm13.jpg',
    alt: 'Операційний блок - зона безпеки та стерильності',
    width: 800,
    height: 600,
    title: 'Сучасний операційний блок',
  },
  {
    src: '/images/sterility/steroper6.jpg',
    alt: 'Медичний персонал у стерильному одязі',
    width: 800,
    height: 600,
    title: 'Стерильний одяг медичного персоналу',
  },
  {
    src: '/images/sterility/steroper7.jpg',
    alt: 'Стерилізація хірургічних інструментів',
    width: 800,
    height: 600,
    title: 'Процес стерилізації інструментів',
  },
  {
    src: '/images/sterility/steroper1.jpg',
    alt: 'Сучасний операційний блок зі стерильним середовищем',
    width: 800,
    height: 600,
    title: 'Стерильне середовище операційної',
  },
];

export function OperatingSterilityGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=operating room sterility' ||
              '/placeholder.svg'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=operating room sterility thumbnail' ||
                        '/placeholder.svg'
                      }
                      alt={image.alt}
                      width={100}
...
export default OperatingSterilityGallery;
