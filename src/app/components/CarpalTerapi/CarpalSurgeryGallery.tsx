...
const galleryImages = [
  {
    ...
    alt: "Відкрита операція на зап'ясті",
    width: 800,
    height: 600,
    title: "Відкрита операція на зап'ясті",
  },
  {
    src: '/images/сarpalTerapi/carpal3.jpg',
    alt: "Ендоскопічна операція на зап'ясті",
    width: 800,
    height: 600,
    title: "Ендоскопічна операція на зап'ясті",
  },
  {
    src: '/images/сarpalTerapi/carpal4.jpg',
    alt: "Анатомія зап'ястного каналу під час операції",
    width: 800,
    height: 600,
    title: "Анатомія зап'ястного каналу під час операції",
  },
  ...
  },
  {
    ...
    alt: 'Післяопераційне відновлення',
    width: 800,
    height: 600,
    title: 'Післяопераційне відновлення',
  },
  {
...
export function CarpalSurgeryGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=carpal tunnel surgery'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=carpal tunnel surgery thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default CarpalSurgeryGallery;
