...
const galleryImages = [
  ...
  },
  {
    ...
    alt: 'Ергономічні пристрої для роботи',
    width: 800,
    height: 600,
    title: 'Ергономічні пристрої для роботи',
  },
  {
    src: '/images/сarpalTerapi/carpale41.jpg',
    alt: "Компреси для зап'ястя",
    width: 800,
    height: 600,
    title: "Компреси для зап'ястя",
  },
  {
    src: '/images/сarpalTerapi/carpale43.jpg',
    alt: 'Медикаментозне лікування',
    width: 800,
    height: 600,
...
export function CarpalTerapiGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=carpal tunnel treatment'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=carpal tunnel treatment thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default CarpalTerapiGallery;
