          ...
          <div className={styles.twoColumnSection}>
            <div className={styles.textColumn}>
              ...
              <h3 className={styles.subTitle}>
                Зміни на робочому місці для зменшення навантаження на зап'ястя:
              </h3>
              <ul className={styles.bulletList}>
                <li>
                  <span className={styles.emoji}>⌨</span>{' '}
                ...
                <li>
                  ...
                  — наприклад, клавіатура повинна бути досить низько, щоб
                ...
                <li>
                  ...
                  що подразнюють зап'ястя — особливо ті, що передбачають
                  використання вібраційних інструментів.
                </li>
              </ul>
              ...
              <ul className={styles.bulletList}>
                ...
                <li>
                  <span className={styles.emoji}>💉</span>{' '}
                  <strong>Ін'єкції кортикостероїдів</strong> — можуть вводитись
                  у зону карпального каналу для тимчасового полегшення
                  симптомів.
                </li>
              </ul>
            </div>
          ...
          <div className={styles.twoColumnSection}>
            <div className={styles.textColumn}>
              <p className={styles.text}>
                Якщо нехірургічні методи не дають бажаного ефекту, лікар може
                рекомендувати операцію з вивільнення карпального тунелю. Її
              ...
              <p className={styles.text}>
                Обидва методи мають подібні результати, але відрізняються
                технікою виконання. Ваш хірург пояснить, який варіант найкраще
                підходить саме вам.
              </p>
