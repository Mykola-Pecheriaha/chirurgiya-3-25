...
import styles from './AbdominoGalleryFAQ.module.css';
...
interface AbdominoGalleryFAQProps {
  images: ImageType[];
}

const AbdominoGalleryFAQ: React.FC<AbdominoGalleryFAQProps> = ({ images }) => {
      ...
      {isFullscreen && (
        <div className={styles.fullscreenOverlay} onClick={toggleFullscreen}>
          ...
          >
            ...
            {/* Кнопка для відображення мініатюр */}
            <button
...
export default AbdominoGalleryFAQ;
