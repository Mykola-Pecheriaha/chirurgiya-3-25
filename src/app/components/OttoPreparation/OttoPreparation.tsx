...
import OttoGalleryPreparation from './OttoGalleryPreparation';

interface OttoPreparationProps {
  backgroundColor?: string;
}

const OttoPreparation: React.FC<OttoPreparationProps> = ({
      ...
      <div className={styles.content}>
        ...
        <div className={styles.introText}>
          <p>
            ...
            <strong>консультація з пластичним хірургом у Чернівцях</strong>.
            Фахівець приймає пацієнтів не лише з Чернівців, а й з інших міст
            України.
          </p>
          <p>
            На індивідуальній зустрічі пацієнт разом із хірургом обговорює{' '}
            <strong>побажання щодо форми вушної раковини</strong>, можливості
            корекції та очікуваний результат.
          </p>
        </div>
        ...
        <div className={styles.section}>
          <div className={styles.textColumn}>
            <h3 className={styles.sectionTitle}>
              🛡️ Підготовка до отопластики
            </h3>
            <p>
              Заради вашої зручності клініка працює за принципом{' '}
              <strong>«хірургії одного дня»</strong> — консультація, обстеження
              та сама операція проходять в один день!
            </p>
            ...
            <ul className={styles.bulletList}>
              <li>
                припинити прийом гормональних і препаратів, що містять аспірин;
              </li>
              <li>обов'язково повідомити лікаря про всі вживані ліки;</li>
              <li>
                відмовитися від алкоголю і тютюну (або значно обмежити куріння).
              </li>
            </ul>
            <div className={styles.divider}></div>
          </div>
          <div className={styles.galleryColumn}>
            <OttoGalleryPreparation images={preparationImages} />
          </div>
        </div>
        ...
        <div className={styles.section}>
          <div className={styles.textColumn}>
            <h3 className={styles.sectionTitle}>
              ♻️ Реабілітація після отопластики
            </h3>
            <p className={styles.highlight}>
            ...
            <p>
              Це — <strong>нормальні післяопераційні прояви</strong>, які швидко
              зникають завдяки знеболювальним засобам і відпочинку.
            </p>
            <p className={styles.highlight}>
            ...
            <ul className={styles.bulletList}>
              ...
              <li>
                далі — ще 14 днів лише на ніч (можна замінити на щільну
                бандану);
              </li>
              <li>
                шви не знімаються — використовуються саморозсмоктувальні нитки.
              </li>
            </ul>
            <p className={styles.highlight}>
          ...
          <div className={styles.galleryColumn}>
            <OttoGalleryPreparation images={rehabilitationImages} />
          </div>
        </div>
