...
const galleryImages = [
  {
    src: '/images/analFissure/hemorroy.jpg',
    alt: 'Фактори ризику анальної тріщини',
    width: 800,
    height: 600,
    title: 'Фактори ризику анальної тріщини',
  },
  {
    src: '/images/analFissure/analFissure1.jpg',
    alt: 'Симптоми анальної тріщини',
    width: 800,
    height: 600,
    title: 'Симптоми анальної тріщини',
  },
  {
    src: '/images/analFissure/analFissure2.jpg',
    alt: 'Симптоми гострої анальної тріщини',
    width: 800,
    height: 600,
    title: 'Симптоми гострої анальної тріщини',
  },
  {
    src: '/images/analFissure/analFissure15.jpg',
    alt: 'Симптоми хронічної анальної тріщини',
    width: 800,
    height: 600,
    title: 'Симптоми хронічної анальної тріщини',
  },
];

export function SymptomsAnalFissureGallery() {
...
export default SymptomsAnalFissureGallery;
