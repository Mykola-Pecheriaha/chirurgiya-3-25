...
const galleryImages = [
  {
    src: '/images/analFissure/analFissure4.jpg',
    alt: 'Типи анальних тріщин',
    width: 800,
    height: 600,
    title: 'Типи анальних тріщин',
  },
  {
    src: '/images/analFissure/analFissure10.jpg',
    alt: 'Гостра анальна тріщина',
    width: 800,
    height: 600,
    title: 'Гостра анальна тріщина',
  },
  {
    src: '/images/analFissure/analFissure12.jpg',
    alt: 'Хронічна анальна тріщина',
    width: 800,
    height: 600,
    title: 'Хронічна анальна тріщина',
  },
  {
    src: '/images/analFissure/analFissure7.jpg',
    alt: 'Механізм розвитку анальної тріщини',
    width: 800,
    height: 600,
    title: 'Механізм розвитку анальної тріщини',
  },
];

export function AnalFissureGallery() {
...
export default AnalFissureGallery;
