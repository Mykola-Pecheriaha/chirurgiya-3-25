...
const galleryImages = [
  {
    src: '/images/analFissure/analFissure14.jpg',
    alt: 'Консервативне лікування анальної тріщини',
    width: 800,
    height: 600,
    title: 'Консервативне лікування анальної тріщини',
  },
  {
    src: '/images/analFissure/analFissure18.jpg',
    alt: 'Хірургічне лікування анальної тріщини',
    width: 800,
    height: 600,
    title: 'Хірургічне лікування анальної тріщини',
  },
  {
    src: '/images/analFissure/analFissure19.jpg',
    alt: 'Лазерне лікування анальної тріщини',
    width: 800,
    height: 600,
    title: 'Лазерне лікування анальної тріщини',
  },
  {
    src: '/images/analFissure/analFissure20.jpg',
    alt: 'Дієтичні рекомендації при анальній тріщині',
    width: 800,
    height: 600,
    title: 'Дієтичні рекомендації при анальній тріщині',
  },
];

export function TreatmentAnalFissureGallery() {
...
export default TreatmentAnalFissureGallery;
