...
import styles from './CarpalGallery.module.css';

// Визначаємо зображення безпосередньо в компоненті галереї
const galleryImages = [
  {
    src: '/images/carpal/carpale2.jpg',
  ...
  {
    src: '/images/carpal/carpale5.jpg',
    alt: 'Карпальний синдром - стиснення нерва',
    width: 800,
    height: 600,
    title: 'Карпальний синдром - стиснення нерва',
  },
  {
    src: '/images/carpal/carpal6.jpg',
    alt: 'Діагностичний тест на карпальний синдром',
    width: 800,
    height: 600,
    title: 'Діагностичний тест на карпальний синдром',
  },
  {
    src: '/images/carpal/carpale4.jpg',
    alt: 'Методи лікування карпального синдрому',
    width: 800,
    height: 600,
    title: 'Методи лікування карпального синдрому',
  },
];

export function CarpalGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=carpal syndrome'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=carpal syndrome thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
