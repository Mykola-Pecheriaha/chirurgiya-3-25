...
const galleryImages = [
  {
    src: '/images/professional/oper11.jpg',
    alt: 'Хірургічна команда в операційній',
    width: 800,
    height: 600,
    title: 'Злагоджена робота хірургічної бригади',
  },
  {
    src: '/images/professional/oper12.jpg',
    alt: 'Хірург та асистенти під час операції',
    width: 800,
    height: 600,
    title: 'Хірург та асистенти виконують операцію',
  },
  {
    src: '/images/professional/oper13.jpg',
    alt: 'Консультація медичної команди перед операцією',
    width: 800,
    height: 600,
    title: 'Консультація медичної команди перед операцією',
  },
  {
    src: '/images/professional/oper14.jpg',
    alt: 'Анестезіолог контролює стан пацієнта під час операції',
    width: 800,
    height: 600,
    title: 'Анестезіолог контролює стан пацієнта',
  },
  {
    src: '/images/professional/oper15.jpg',
    alt: 'Анестезіолог контролює стан пацієнта під час операції',
    width: 800,
    height: 600,
    title: 'Анестезіолог контролює стан пацієнта',
  ...
  {
    src: '/images/professional/oper16.jpg',
    alt: 'Анестезіолог контролює стан пацієнта під час операції',
    width: 800,
    height: 600,
    title: 'Анестезіолог контролює стан пацієнта',
...
export function OperProfessionalGallery() {
