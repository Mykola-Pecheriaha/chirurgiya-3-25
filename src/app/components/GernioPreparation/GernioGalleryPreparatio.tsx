...
import styles from './GernioGalleryPreparatio.module.css';
...
interface GernioGalleryPreparatioProps {
  images: ImageType[];
}

export const GernioGalleryPreparatio: FC<GernioGalleryPreparatioProps> = ({
  images,
}) => {
