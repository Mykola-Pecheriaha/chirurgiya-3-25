...
import styles from './BariatricsGallery.module.css';

// Визначаємо зображення безпосередньо в компоненті галереї
const galleryImages = [
  {
    src: '/images/bariatrics/bariatrics3.jpg',
    alt: 'Рукавна резекція шлунка',
    width: 800,
    height: 600,
    title: 'Рукавна резекція шлунка (sleeve-резекція)',
  },
  {
    src: '/images/bariatrics/bariatrics4.jpg',
    alt: 'Мінігастрошунтування',
    width: 800,
    height: 600,
    title: 'Мінігастрошунтування (Mini Gastric Bypass)',
  },
  {
    src: '/images/bariatrics/bariatrics5.jpg',
    alt: 'Гастрошунтування',
    width: 800,
    height: 600,
    title: 'Гастрошунтування',
  },
  {
    src: '/images/bariatrics/bariatrics6.jpg',
    alt: 'Операція Sadi',
    width: 800,
    height: 600,
    title: 'Операція Sadi (біліопанкреатичне шунтування)',
  },
  {
    src: '/images/bariatrics/bariatrics7.jpg',
    alt: 'Внутрішньошлунковий балон',
    width: 800,
    height: 600,
    title: 'Установка внутрішньошлункового балона',
  },
];

export function BariatricsGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=bariatric surgery'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=bariatric surgery thumbnail'
                      }
                      alt={image.alt}
                      width={100}
                      height={75}
...
export default BariatricsGallery;
