...
const galleryImages = [
  {
    src: '/images/equipment/surgical20.jpg',
    alt: 'Сучасне хірургічне обладнання',
    width: 800,
    height: 600,
    title: 'Хірургічна система нового покоління',
  },
  {
    src: '/images/equipment/oprerster3.jpg',
    alt: 'Операційний стіл з моніторами',
    width: 800,
    height: 600,
    title: 'Високоточне обладнання для моніторингу',
  },
  {
    src: '/images/equipment/operromm10.jpg',
    alt: 'Лапароскопічне обладнання',
    width: 800,
    height: 600,
    title: 'Лапароскопічна система для мінімально інвазивних втручань',
  },
  {
    src: '/images/equipment/operromm5.jpg',
    alt: 'Хірургічні інструменти',
    width: 800,
    height: 600,
    title: 'Сучасні хірургічні інструменти',
  },
];

export function OperModernGallery() {
...
export default OperModernGallery;
