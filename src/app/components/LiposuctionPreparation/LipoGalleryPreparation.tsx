...
import styles from './LipoGalleryPreparation.module.css';
...
interface LipoGalleryPreparationProps {
  images: GalleryImage[];
}

export function LipoGalleryPreparation({
  images,
}: LipoGalleryPreparationProps) {
...
export default LipoGalleryPreparation;
