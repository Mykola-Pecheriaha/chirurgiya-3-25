...
const galleryImages = [
  {
    ...
    width: 800,
    height: 600,
    title: 'Класичне хірургічне висічення нориці',
  },
  {
    src: '/images/pararectal/pararecta18.jpg',
    alt: 'Радіохвильове лікування нориці',
    width: 800,
    height: 600,
    title: 'Радіохвильове висічення нориці',
  },
  {
    src: '/images/pararectal/pararecta22.jpg',
    alt: 'Лазерна абляція нориці',
    width: 800,
    height: 600,
    title: 'Лазерна абляція параректальної нориці',
  },
  {
    ...
    width: 800,
    height: 600,
    title: 'Рекомендації після операції',
  },
];

export function PararectalTerapyGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=pararectal treatment' ||
              '/placeholder.svg' ||
              '/placeholder.svg' ||
              '/placeholder.svg'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=pararectal treatment thumbnail' ||
                        '/placeholder.svg' ||
                        '/placeholder.svg' ||
                        '/placeholder.svg'
                      }
