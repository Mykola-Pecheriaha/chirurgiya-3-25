...
const galleryImages = [
  {
    src: '/images/pararectal/pararecta5.jpg',
    alt: 'Анатомія параректальної нориці',
    width: 800,
    height: 600,
    title: 'Анатомія параректальної нориці',
  },
  {
    src: '/images/pararectal/pararecta6.jpg',
    alt: 'Типи параректальних нориць',
    width: 800,
    height: 600,
    title: 'Класифікація нориць за розташуванням',
  },
  {
    src: '/images/pararectal/pararecta7.jpg',
    alt: 'Стадії розвитку нориці',
    width: 800,
    height: 600,
    title: 'Стадії розвитку параректальної нориці',
  },
  {
    src: '/images/pararectal/analFissure13.jpg',
    alt: 'Фактори ризику параректальної нориці',
    width: 800,
    height: 600,
    title: 'Фактори ризику розвитку нориці',
  },
];

export function PararectalFistulasGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=pararectal fistula' ||
              '/placeholder.svg' ||
              '/placeholder.svg'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=pararectal thumbnail' ||
                        '/placeholder.svg' ||
                        '/placeholder.svg'
                      }
                      alt={image.alt}
