...
const galleryImages = [
  ...
  },
  {
    ...
    width: 800,
    height: 600,
    title: 'Методи діагностики нориці',
  },
  {
    ...
    width: 800,
    height: 600,
    title: 'Можливі ускладнення без лікування',
  },
  {
    src: '/images/pararectal/pararecta13.jpg',
    alt: 'Коли звертатися до лікаря',
    width: 800,
    height: 600,
    title: 'Показання для звернення до проктолога',
  },
  {
...
export function PararectalSymptomGallery() {
      ...
      <div className={styles.gallery}>
        ...
        <div className={styles.imageContainer}>
          ...
          <Image
            src={
              currentImage.src ||
              '/placeholder.svg?height=600&width=800&query=pararectal symptoms' ||
              '/placeholder.svg' ||
              '/placeholder.svg' ||
              '/placeholder.svg'
            }
                ...
                {galleryImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={
                        image.src ||
                        '/placeholder.svg?height=75&width=100&query=pararectal symptom thumbnail' ||
                        '/placeholder.svg' ||
                        '/placeholder.svg' ||
                        '/placeholder.svg'
                      }
