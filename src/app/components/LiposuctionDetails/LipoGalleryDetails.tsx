...
import styles from './LipoGalleryDetails.module.css';
...
interface LipoGalleryDetailsProps {
  images: GalleryImage[];
}

export function LipoGalleryDetails({ images }: LipoGalleryDetailsProps) {
...
export default LipoGalleryDetails;
