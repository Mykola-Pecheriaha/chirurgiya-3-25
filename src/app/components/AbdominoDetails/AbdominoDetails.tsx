...
import AbdominoGallery from './AbdominoGallery';

interface AbdominoDetailsProps {
  backgroundColor?: string;
}

const AbdominoDetails: React.FC<AbdominoDetailsProps> = ({
          ...
          <div className={styles.textColumn}>
            ...
            <div className={styles.indicationsList}>
              ...
              <ul className={styles.list}>
                <li>
                  <span className={styles.bulletPoint}>🔸</span> Відвислий
                  шкірно-жировий «фартух», що виникає після:
                ...
                <li>
                  <span className={styles.bulletPoint}>🔸</span> Втрата
                  еластичності м'язів живота:
                  <ul className={styles.subList}>
                    <li>птоз</li>
                    <li>в'ялість</li>
                ...
                <li>
                  <span className={styles.bulletPoint}>🔸</span> Неестетичний
                  зовнішній вигляд через:
                  <ul className={styles.subList}>
                    <li>
                      післяопераційні втягнуті рубці (наприклад, після
                      кесаревого розтину)
                    </li>
                  </ul>
                </li>
                <li>
                  <span className={styles.bulletPoint}>🔸</span> Грижа білої
                  лінії живота у поєднанні з розтягнутою шкірою
                </li>
              </ul>
            </div>
          </div>
          <div className={styles.galleryColumn}>
            <AbdominoGallery images={indicationImages} />
          </div>
        </div>
        ...
        <div className={styles.fullWidthSection}>
          <div className={styles.infoBlock}>
            ...
            <p className={styles.infoText}>
              ...
              результати, тому доцільно робити операцію після остаточного
              формування сім'ї. Водночас усе індивідуально — важливу роль
              відіграють:
            </p>
          ...
          <div className={styles.infoBlock}>
            ...
            <p className={styles.infoText}>
              Це особливо актуально для молодих мам, які хочуть відновити
              допологову форму, а також для жінок після значного схуднення.
            </p>
          </div>
          ...
          <div className={styles.infoBlock}>
            ...
            <p className={styles.infoText}>
              Операція виконується лише при стабільній вазі. Якщо пацієнт
              продовжить худнути після втручання, це може призвести до надлишку
              шкіри, що знову потребуватиме корекції.
            </p>
          </div>
        </div>

        {/* Заголовок протипоказань */}
        <h2 className={styles.contraindicationsTitle}>
          🚫 Протипоказання до абдомінопластики
        </h2>
        <p className={styles.contraindicationsIntro}>
          Абдомінопластика живота, як і будь-яке інше хірургічне втручання, має
          ряд медичних протипоказань, які необхідно враховувати перед
          плануванням операції.
        </p>

        {/* Друга секція: протипоказання */}
        <div className={styles.section}>
          <div className={styles.textColumn}>
            <div className={styles.contraindicationsList}>
              ...
              <ul className={styles.list}>
                <li>
                  <span className={styles.bulletPoint}>❗</span> Хронічні
                  захворювання:
                  <ul className={styles.subList}>
                ...
                <li>
                  <span className={styles.bulletPoint}>❗</span> Порушення
                  згортання крові
                  <p className={styles.note}>
                ...
                <li>
                  <span className={styles.bulletPoint}>❗</span> Серйозні
                  психічні розлади
                  <p className={styles.note}>
                    Операція потребує усвідомленого та стабільного
          ...
          <div className={styles.galleryColumn}>
            <AbdominoGallery images={contraindicationImages} />
          </div>
        </div>
